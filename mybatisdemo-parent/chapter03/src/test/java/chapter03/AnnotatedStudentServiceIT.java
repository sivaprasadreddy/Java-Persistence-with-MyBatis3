...
import chapter03.annotations.AnnotatedStudentService;
...
public class AnnotatedStudentServiceIT 
{
	private static AnnotatedStudentService studentService;
	
	@BeforeClass
	public static void setup()
	{
		studentService = new AnnotatedStudentService();
	}
	@AfterClass
